...
public class BuyerSteps extends Steps {
    ...
    public String checkBuyerBillingInformation() throws SQLException {
        ...
        errorMessage.append(verifyExpectedResults(
                buyerTable.getJsonAndTableDecryptValue(buyerID, "billing_address", "address_line_1")));
        errorMessage.append(verifyExpectedResults(
                buyerTable.getJsonAndTableDecryptValue(buyerID, "billing_address", "address_line_2")));
        errorMessage.append(verifyExpectedResults(
                buyerTable.getJsonAndTableDecryptValue(buyerID, "billing_address", "city")));
        errorMessage.append(verifyExpectedResults(
        ...
        errorMessage.append(verifyExpectedResults(
                buyerTable.getJsonAndTableDecryptValue(buyerID, "billing_address", "first_name")));
        errorMessage.append(verifyExpectedResults(
                buyerTable.getJsonAndTableDecryptValue(buyerID, "billing_address", "last_name")));
