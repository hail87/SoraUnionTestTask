...
//    }
    ...
    public okhttp3.Response partialSearchExcludingIDsProductCatalogManagement(String productName,
                                                                              int productIdToExclude,
                                                                              String authToken) {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .build();
        MediaType mediaType = MediaType.parse("application/json");

        logger.info("{\n    \"product_name\": \"" + productName + "\",\n    \"product_ids\": [{" + productIdToExclude + "}],\n    \"max_results\": 10\n}");
        logger.info("\n ID to exclude: '" + productIdToExclude + "'\n");
        RequestBody body = RequestBody.create(mediaType,
                "{\n    \"product_name\": \"" + productName + "\",\n    \"product_ids\": [" + productIdToExclude + "],\n    \"max_results\": 10\n}");
        Request request = new Request.Builder()
                .url(DataUtils.getPropertyValue("url.properties", "partialProductSearch"))
    ...
    public okhttp3.Response getResellersList(String authToken) {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .build();
        Request request = new Request.Builder()
                .url("https://fs6wjwxd00.execute-api.us-east-1.amazonaws.com/dev/api/v1/rp/resellers")
                .method("GET", null)
    ...
    public okhttp3.Response getResellerInformation(int resellersID, String authToken) {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .build();
        Request request = new Request.Builder()
                .url("https://fs6wjwxd00.execute-api.us-east-1.amazonaws.com/dev/api/v1/rp/resellers/" + resellersID)
                .method("GET", null)
                .addHeader("authority", "fs6wjwxd00.execute-api.us-east-1.amazonaws.com")
                .addHeader("accept", "application/json, text/plain, /")
                .addHeader("accept-language", "en-GB,en-US;q=0.9,en;q=0.8")
