...
where productID NOT in (2295, 2391, 2392, 2753, 3508, 4606, 90577, 90562, 90953) and productID > 0;
...
where buyerAccountID NOT in (1526, 1528, 1529, 1531, 1894, 10089) and buyerAccountID > 0;