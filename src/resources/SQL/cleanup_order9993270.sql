...
where orderID = (SELECT orderID from lwa_test_enc.orders where orderAllSysID = 9993270);
...
SELECT warehouseOrderID FROM lwa_test_enc.warehouseOrder WHERE orderID = (SELECT orderID from lwa_test_enc.orders where orderAllSysID = 9993270)));
...
where orderAllSysID = 9993270;

delete from lwa_test_enc.orderCheckSum
where orderID=9993270;