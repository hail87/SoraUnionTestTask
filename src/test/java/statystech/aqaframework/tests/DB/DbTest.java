...
public class DbTest extends TestClass {
    ...
    public void newOrderProcessing(String jsonFilename, TestInfo testInfo) throws IOException, SQLException {
        ...
        int id = stageOrderSteps.insertJsonToTableAndContext(jsonFilename, getTestRailID(testInfo));
...
//    }
    ...
    public void addProductsTest(String jsonFilename, TestInfo testInfo) throws IOException, SQLException {
        ...
        int id = stageProductSteps.insertJsonToTableAndContext(jsonFilename, getTestRailID(testInfo));
